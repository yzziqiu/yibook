...
public class BottomView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        imgHeadLeft = (ImageView) findViewById(com.got3.yibook.R.id.bvimg_head_left);
       // imgHeadNotice = (ImageView) findViewById(com.got3.yibook.R.id.img_head_notice);
      //  tvHeadCenter = (TextView) findViewById(com.got3.yibook.R.id.bvtv_head_center);
     //   imgHeadCenter = (ImageView) findViewById(com.got3.yibook.R.id.bvimg_head_center);
        tvHeadRight = (TextView) findViewById(com.got3.yibook.R.id.bv_head_right);
        imgHeadRight = (ImageView) findViewById(com.got3.yibook.R.id.bv_img_head_right);
        rlHeadRight = (RelativeLayout) findViewById(com.got3.yibook.R.id.bv_relative_head_right);
        rlHeadLeft = (RelativeLayout) findViewById(com.got3.yibook.R.id.bvrelative_head_left);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case com.got3.yibook.R.id.bvrelative_head_left:
                    if (headViewListener != null) {
                        headViewListener.onClickLeft();
                    }
                    break;
                case com.got3.yibook.R.id.bv_relative_head_right:
                    if (headViewListener != null) {
    ...
    public void showLine(boolean isShow) {
        findViewById(R.id.bvview_line).setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
